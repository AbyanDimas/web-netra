        ...
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex">
              ...
              <a
                ...
                title="Our phone"
                className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800 dark:hover:text-deep-purple-300"
              >
                850-123-5021
              </a>
            </div>
          ...
          <div>
            ...
            <div className="flex items-center mt-1 space-x-3">
              <a
                href="/"
                className="text-gray-500 dark:text-gray-400 transition-colors duration-300 hover:text-deep-purple-accent-400"
              >
